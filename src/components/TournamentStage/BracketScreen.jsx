...
export default function BracketScreen({
  ...
  <h2 className="text-lg font-black uppercase tracking-[0.3em] text-amber-400">
    Disputa de 3º Lugar
        ...
        <MatchCard match={qf2} label="Quartas 2" className="left-[20px] top-[290px]" />
        <MatchCard match={qf3} label="Quartas 3" className="left-[20px] top-[570px]" />
        <MatchCard match={qf4} label="Quartas 4" className="left-[20px] top-[800px]" />

        {/* Semifinais */}
        <MatchCard match={sf1} label="Semifinal 1" className="left-[660px] top-[175px]" />
        <MatchCard match={sf2} label="Semifinal 2" className="left-[660px] top-[685px]" />
...
/>
        ...
        <BracketConnector left={530} top={275} width={130} />

        <BracketConnector left={410} top={670} width={120} />
        <BracketConnector left={410} top={900} width={120} />
        ...
        <BracketConnector left={530} top={785} width={130} />

        {/* Semi -> Final */}
        <BracketConnector left={1050} top={275} width={100} />
        <BracketConnector left={1050} top={785} width={100} />
        ...
        <BracketConnector left={1150} top={530} width={110} />
