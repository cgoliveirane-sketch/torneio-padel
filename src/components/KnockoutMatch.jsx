export default function KnockoutMatch({
  ...
  <div className="text-xs font-semibold text-slate-500">
    {match.finished ? "🏆 Vencedor" : "Pendente"}
  </div>
    ...
    <div className="mt-1 text-xs font-bold text-emerald-700">
      {winner}
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_auto_1fr]">
              <div className="text-center">
                ...
                <select
                  ...
                  className="mx-auto block w-24 rounded-xl border bg-white px-3 py-2 text-center text-xl font-bold disabled:opacity-60"
                >
                  <option value="">-</option>
            ...
            <button
              ...
              className="mt-4 w-full rounded-xl bg-slate-900 px-4 py-2 font-semibold text-white hover:bg-slate-700 disabled:cursor-not-allowed disabled:bg-emerald-700"
            >
              {match.finished
